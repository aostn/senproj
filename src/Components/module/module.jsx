        ...
        <div>
            ...
            <div className="module-box">
                <ul className="itemsList">
                    <div className="item">
                        <li className="item1"><Link to="/modules" state={{moduleId : 1}} ><h3>Module 1:</h3> <br/>Intro to Stocks</Link></li>
                        <li className="item2"><Link to="/modules" state={{moduleId : 2}} ><h3>Module 2:</h3> <br/>Intro to Options</Link></li>
                        <li className="item3"><Link to="/modules" state={{moduleId : 3}} ><h3>Module 3:</h3> <br/>Technical Analysis</Link></li>
                    </div>
                </ul>
            </div>
        </div>
